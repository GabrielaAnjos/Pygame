...
pygame.display.set_caption("Simple War Game!")
...
HEALTH_FONT = pygame.font.SysFont('century', 40)
WINNER_FONT = pygame.font.SysFont('comicsan', 100)
TIP_FONT = pygame.font.SysFont("monospace", 20)
...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
    ...
    WIN.blit(red_health_text, (WIDTH - red_health_text.get_width() - 120, 10))
    WIN.blit(yellow_health_text, (WIDTH - yellow_health_text.get_width() - 580, 10))

    red_tip = TIP_FONT.render("up, down, left, right, end", 1, WHITE)
    WIN.blit(red_tip, (WIDTH - red_tip.get_width() - 60, HEIGHT - 50))
